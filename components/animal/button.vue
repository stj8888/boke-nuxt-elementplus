...
<div v-if="show.length===0">
  <el-skeleton style="width: 240px" animated>
    <template #template>
      <el-skeleton-item variant="image" style="width: 940px; height: 640px" />
    </template>
  </el-skeleton>
</div>
<div v-else class="swiper" style="width: 100%; height: 100%; margin-left: 50px;">
  <el-carousel height="600px" direction="vertical"  >
    <el-carousel-item v-for="item in list" :key="item">
      <span>{{ item.title }}</span>
      <img :src="item.photo" alt="vue"  @click="hande(item.link)">
    </el-carousel-item>
  </el-carousel>
</div>
</div>
...
const list=[
  {
    photo:'swiper/vue2.png',
    title:'Vue的学习',
    link:'https://cn.vuejs.org/'
  },
  {
    photo:'swiper/nuxt.png',
    title:'nuxt3的学习',
    link:'https://nuxt.com.cn/'
  },
  {
    photo:'swiper/github.png',
    title:'github的学习',
    link:'https://github.com/'
  },
  {
    photo:'swiper/juejin.png',
    title:'掘金的学习',
